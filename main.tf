...
variable "params" {
  default = [
    ...
    { name = "roboshop.dev.catalogue.docdb_endpoint", value = "docdb-dev.cluster-cx8kkrzk6cpv.us-east-1.docdb.amazonaws.com", type = "String" },

    { name = "roboshop.dev.user.mongo_url", value = "mongodb://roboshop:roboshop123@docdb-dev.cluster-cx8kkrzk6cpv.us-east-1.docdb.amazonaws.com:27017/users?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false", type = "SecureString" },
    { name = "roboshop.dev.user.docdb_endpoint", value = "docdb-dev.cluster-cx8kkrzk6cpv.us-east-1.docdb.amazonaws.com", type = "String" },
